        ...
        <div className="listItem" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} style={{left: isHovered && index * 225 - 50 + index * 2.5}}>
            ...
            <>
                ...
                <div className="itemInfo">
                    ...
                    <div className="desc">
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quibusdam, tempora eveniet? Qui deleniti nostrum quae ducimus laudantium voluptate ratione reiciendis.
                    </div>
